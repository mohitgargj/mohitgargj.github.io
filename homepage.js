...
var countDownDate = new Date("Apr 26, 2021 09:00:00").getTime();
...
var x = setInterval(function() {
  ...
  document.getElementById("timer").innerHTML =
   "<span class='time_no'> " + days + "</span>"+
   "<span class='time_alp'> Days  </span>"+
   "<span class='time_no'> " + hours + "</span>"+
   "<span class='time_alp'> Hours  </span>"+
   "<span class='time_no'> " + minutes + "</span>"+
   "<span class='time_alp'> Mins  </span>"+
   "<span class='time_no'> " + seconds + "</span>"+
   "<span class='time_alp'> Secs  </span>";
